...
class HealthDetector(nn.Module):
    def __init__(self, uwb_len, bre_len, hrt_len, device):
        ...
        # Encoder:
        self.e1_1 = EncoderLayer(in_ch=3, out_ch=out_channels[0])  # 2->8
        ...
        self.e1_2 = EncoderLayer(in_ch=3, out_ch=out_channels[0])  # 2->8
    ...
    def forward(self, uwb_1, uwb_2):
        ...
        # uwb_1 = torch.flatten(uwb_1)
        # uwb_2 = torch.flatten(uwb_2)
        # out1 = self.all_linear(uwb_1)
        # out2 = self.all_linear(uwb_2)
        # out_bre = self.bre_linear(out1)
        # out_hrt = self.hrt_linear(out1)
        return out_bre, out_hrt, out6_1, out6_2
